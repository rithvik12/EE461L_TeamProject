...
export default class ProjectsList extends Component {
    constructor(props) {
      ...
      componentDidMount() {
        ...
        axios.get('https://quiet-lowlands-32326.herokuapp.com/projects/')
         .then(response => {
      ...
      deleteProject(id) {
        axios.delete('https://quiet-lowlands-32326.herokuapp.com/hardwares/'+(id+1))
        .then(res => console.log(res.data));
        axios.delete('https://quiet-lowlands-32326.herokuapp.com/projects/'+id)
          .then(res => console.log(res.data));
        this.setState({
